...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "education":
            ...
            break;
        case "18cs31":
            sendTextMessage("<span class='sk'>Thank you<br>The Notes Available<br>Here to view Click on<a target='_blank' href='https://drive.google.com/file/d/1HlzZFcD5sMYxWkhQJcIr7SgHATYXD7hR/view?usp=sharing'>Click Here</a>")//<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br>C<br>PHP<br>Kotlin<br>Dart<br><br>CSS<br>HTML<br>JavaScript</span><br><br>I am well versed with following frameworks :<span class='bold'><br>Android<br>Flutter<br>ReactJs</span><br>");
            break;
        case "18cs32":
            sendTextMessage("<span class='sk'>I am currently Under Training it will complete Soon.")//<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br>C<br>PHP<br>Kotlin<br>Dart<br><br>CSS<br>HTML<br>JavaScript</span><br><br>I am well versed with following frameworks :<span class='bold'><br>Android<br>Flutter<br>ReactJs</span><br>");
            break;
